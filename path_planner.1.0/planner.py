...
#..........................................................................
def astar(start, goal, obstacles,vector):
    """A* algorithm."""
    ...
    while front:
        ...
        if visited[pos] > 0:
            continue
        visited[pos] = cost
        vector[pos[0],pos[1],0] = cost

        # Now it has been
        #  visited. Mark with cost.
...
#..........................................................................
def update_path(start, goal,world_obstacles,pos_vector):
    # First apply distance transform to world_obstacles.
    # Call path planning algorithm.
    optimal_path, visited_nodes = astar(start,goal, world_obstacles,pos_vector)
...
if __name__ == '__main__':
    ...
    while(True):
        ...
        if(result):
            index = result[0][0]
        else:  # get last known index if the result if the  result
        ...
        if result:
            ...
            quary_get = "SELECT * FROM SLAM WHERE No = '" + str(index) + "'"
            ...
            #############..............................
            #..........................................pos_vector
            dim = [canvas_extents[0],canvas_extents[1],2]
            pos_vector = np.zeros(dim, dtype=np.uint8)
            #..........................................
            ...
            #..........................................
            pos_vector[0:,0:,1] = world_obstacles
            #..........................................
            ...
            if(Y >= canvas_extents[1]):
                Y = Y -1;
            path,pos_vector = update_path((X,canvas_extents[1]-Y),(x,y), world_obstacles,pos_vector)
            ########################---seting up visited data
            control.set_Vector(pos_vector.tolist())
            ...
            quary_path = "INSERT INTO Path_planner( path, slamref, goal, X_base, Y_base, isNew ) values('" + str(path) + "','"+ str(index)+"','"+str(goal)+"','"+ str(base[0])+"','"+ str(base[1]) +"','"+ str(1)+"')"
            SQL_CMD(connection, quary_path)
            ##################################//make old obstacle data obsalate
            quary2 = "UPDATE Data_ref SET is_New = '0' WHERE No = '" + str(index) + "'"
